...
public class ArmSuperStructureState {
    private Arm_Modes wantedMode = Arm_Modes.PICK_ITEMS_POS;
    ...
    public boolean comparePos(ArmSuperStructureState other){
        return this.currentArmPos == other.getCurrentArmPos();
    }

    public boolean compareStates(ArmSuperStructureState other){
